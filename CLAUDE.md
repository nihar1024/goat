...
- `apps/core` — Main FastAPI backend: user management, projects, folders, scenarios, metadata. Uses SQLAlchemy/SQLModel + PostgreSQL/PostGIS, Alembic migrations, Redis for caching; background jobs run in Windmill
