...
Die **Projekte**-Seite ist Ihr zentraler Hub zum Erstellen, Verwalten und Teilen von **Projekten** in GOAT. Hier können Sie all Ihre Arbeit mit einer klaren Übersicht über Ihre **Projekte** organisieren, kategorisiert in **Persönliche Projekte**, **Team-Projekte** und **Organisationsweite Projekte**. Hier können Sie:

- **Projekte organisieren** in benutzerdefinierten Ordnern für bessere Struktur
...
<div class="step">
  ...
  <div class="content">Navigieren Sie zur <code>Projekte</code>-Seite über die Seitenleisten-Navigation.</div>
</div>
