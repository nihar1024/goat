...
TOOL_REGISTRY: tuple[ToolDefinition, ...] = (
    ...
    ToolDefinition(
        name="catchment_area",
        display_name="Catchment Area (Legacy)",
    ...
    # Heatmap tools: each v1 (matrix-based) tool is paired with its v2 (on-the-fly
    # C++ routing) counterpart. Order: v1, v2 for each formula — gravity,
    # closest_average, connectivity.
    ToolDefinition(
